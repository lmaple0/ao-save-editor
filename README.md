...
- `ao_achievement_i18n.json`: achievement names/descriptions keyed by the direct NISA `game_achievement_id` bitmap bit; Joyoland Chinese names are reconciled against the user-supplied achievement table by acquisition condition.
