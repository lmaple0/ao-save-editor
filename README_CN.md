...
编辑器里的中文物品名称、部分界面名称和代码表，主要取自欢乐百世简体中文 PC 版《碧之轨迹》以及 BZH 原工具数据。物品页现在可按 `ao_item_i18n.json` 中已匹配的 ID 切换中文、英文、日文名称；成就页也可按 `ao_achievement_i18n.json` 切换中文、英文、日文名称；缺失英日名时回退到中文。因此它们仍可能与以下文本不完全一致：
